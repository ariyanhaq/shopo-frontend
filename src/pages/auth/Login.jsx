/**
 * @file Login.jsx
 * @description Laptop screen viewport-fitted (h-screen) minimal SaaS Login page.
 */
  ...
  return (
    <div className="h-screen max-h-screen overflow-hidden grid grid-cols-1 lg:grid-cols-2 bg-[#FAFBFD] text-slate-800">
      ...
      <div className="flex flex-col justify-between p-6 sm:p-8 lg:p-10 h-screen overflow-y-auto lg:overflow-hidden">
        ...
        <div className="w-full max-w-md mx-auto my-auto space-y-4 sm:space-y-5 py-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 pt-1">
            ...
            <div>
              <input
                type="text"
                required
                placeholder={lang === 'bn' ? 'ইমেইল বা মোবাইল নাম্বার' : 'email@example.com'}
                value={formData.identifier}
                onChange={(e) => setFormData({ ...formData, identifier: e.target.value })}
                className="w-full px-4 py-2.5 sm:py-3 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00df89]/40 focus:border-emerald-500 font-medium shadow-2xs transition-all"
              />
            </div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-10 py-2.5 sm:py-3 bg-white border border-slate-200 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00df89]/40 focus:border-emerald-500 font-medium shadow-2xs transition-all"
              />
              <button
                type="button"
            ...
            <button
              type="submit"
              className="w-full py-2.5 sm:py-3 px-4 bg-[#00df89] hover:bg-[#00c97b] text-[#011812] font-bold rounded-xl text-sm shadow-md shadow-[#00df89]/20 transition-all transform active:scale-[0.99]"
            >
          ...
          >
            ...
            <span>{lang === 'bn' ? 'Google দিয়ে লগইন' : 'Login with Google'}</span>
          </button>
